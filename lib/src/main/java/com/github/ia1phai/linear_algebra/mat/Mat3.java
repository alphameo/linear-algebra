...
public class Mat3 implements Matrix3, Copyable<Mat3> {
    ...
    @Override
    public float get(Matrix3Row row, Matrix3Col col) {
    ...
    @Override
    public void set(Matrix3Row row, Matrix3Col col, float value) {
    ...
    public Matrix3 minorMatrix(int row, int col) {
